...
private static extern(C) int Soloud_pause(int* aObjHandle);
private static extern(C) int Soloud_resume(int* aObjHandle);
...
private static extern(C) uint Soloud_getMainResampler(int* aObjHandle);
...
private static extern(C) int Soloud_getAutoStop(int* aObjHandle, uint aVoiceHandle);
...
private static extern(C) void Soloud_setAutoStop(int* aObjHandle, uint aVoiceHandle, int aAutoStop);
...
private static extern(C) void Soloud_setMainResampler(int* aObjHandle, uint aResampler);
...
private static extern(C) void Soloud_setChannelVolume(int* aObjHandle, uint aVoiceHandle, uint aChannel, float aVolume);
...
private static extern(C) int* Ay_create();
private static extern(C) int* Ay_destroy(int* aObjHandle);
private static extern(C) void Ay_setVolume(int* aObjHandle, float aVolume);
private static extern(C) void Ay_setLooping(int* aObjHandle, int aLoop);
private static extern(C) void Ay_setAutoStop(int* aObjHandle, int aAutoStop);
private static extern(C) void Ay_set3dMinMaxDistance(int* aObjHandle, float aMinDistance, float aMaxDistance);
private static extern(C) void Ay_set3dAttenuation(int* aObjHandle, uint aAttenuationModel, float aAttenuationRolloffFactor);
private static extern(C) void Ay_set3dDopplerFactor(int* aObjHandle, float aDopplerFactor);
private static extern(C) void Ay_set3dListenerRelative(int* aObjHandle, int aListenerRelative);
private static extern(C) void Ay_set3dDistanceDelay(int* aObjHandle, int aDistanceDelay);
private static extern(C) void Ay_set3dColliderEx(int* aObjHandle, int* aCollider, int aUserData);
private static extern(C) void Ay_set3dAttenuator(int* aObjHandle, int* aAttenuator);
private static extern(C) void Ay_setInaudibleBehavior(int* aObjHandle, int aMustTick, int aKill);
private static extern(C) void Ay_setLoopPoint(int* aObjHandle, double aLoopPoint);
private static extern(C) double Ay_getLoopPoint(int* aObjHandle);
private static extern(C) void Ay_setFilter(int* aObjHandle, uint aFilterId, int* aFilter);
private static extern(C) void Ay_stop(int* aObjHandle);
...
private static extern(C) uint Bus_getResampler(int* aObjHandle);
private static extern(C) void Bus_setResampler(int* aObjHandle, uint aResampler);
...
private static extern(C) void Bus_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Monotone_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Noise_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Openmpt_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Queue_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Sfxr_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Speech_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void TedSid_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Vic_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Vizsn_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void Wav_setAutoStop(int* aObjHandle, int aAutoStop);
...
private static extern(C) void WavStream_setAutoStop(int* aObjHandle, int aAutoStop);
