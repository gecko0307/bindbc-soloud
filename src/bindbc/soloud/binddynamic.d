...
extern(C)
{
    ...
    alias @nogc nothrow int function(int* aObjHandle) da_Soloud_pause;
    alias @nogc nothrow int function(int* aObjHandle) da_Soloud_resume;
    ...
    alias @nogc nothrow uint function(int* aObjHandle) da_Soloud_getMainResampler;
    ...
    alias @nogc nothrow int function(int* aObjHandle, uint aVoiceHandle) da_Soloud_getAutoStop;
    ...
    alias @nogc nothrow void function(int* aObjHandle, uint aVoiceHandle, int aAutoStop) da_Soloud_setAutoStop;
    ...
    alias @nogc nothrow void function(int* aObjHandle, uint aVoiceHandle, float aLVolume, float aRVolume) da_Soloud_setPanAbsolute;
    alias @nogc nothrow void function(int* aObjHandle, uint aVoiceHandle, uint aChannel, float aVolume) da_Soloud_setChannelVolume;
    ...
    alias @nogc nothrow int* function() da_Ay_create;
    alias @nogc nothrow int* function(int* aObjHandle) da_Ay_destroy;
    alias @nogc nothrow void function(int* aObjHandle, float aVolume) da_Ay_setVolume;
    alias @nogc nothrow void function(int* aObjHandle, int aLoop) da_Ay_setLooping;
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Ay_setAutoStop;
    alias @nogc nothrow void function(int* aObjHandle, float aMinDistance, float aMaxDistance) da_Ay_set3dMinMaxDistance;
    alias @nogc nothrow void function(int* aObjHandle, uint aAttenuationModel, float aAttenuationRolloffFactor) da_Ay_set3dAttenuation;
    alias @nogc nothrow void function(int* aObjHandle, float aDopplerFactor) da_Ay_set3dDopplerFactor;
    alias @nogc nothrow void function(int* aObjHandle, int aListenerRelative) da_Ay_set3dListenerRelative;
    alias @nogc nothrow void function(int* aObjHandle, int aDistanceDelay) da_Ay_set3dDistanceDelay;
    alias @nogc nothrow void function(int* aObjHandle, int* aCollider, int aUserData) da_Ay_set3dColliderEx;
    alias @nogc nothrow void function(int* aObjHandle, int* aAttenuator) da_Ay_set3dAttenuator;
    alias @nogc nothrow void function(int* aObjHandle, int aMustTick, int aKill) da_Ay_setInaudibleBehavior;
    alias @nogc nothrow void function(int* aObjHandle, double aLoopPoint) da_Ay_setLoopPoint;
    alias @nogc nothrow double function(int* aObjHandle) da_Ay_getLoopPoint;
    alias @nogc nothrow void function(int* aObjHandle, uint aFilterId, int* aFilter) da_Ay_setFilter;
    alias @nogc nothrow void function(int* aObjHandle) da_Ay_stop;
    ...
    alias @nogc nothrow int function(int* aObjHandle) da_BassboostFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_BassboostFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_BassboostFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_BassboostFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_BassboostFilter_getParamMin;
    ...
    alias @nogc nothrow int function(int* aObjHandle) da_BiquadResonantFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_BiquadResonantFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_BiquadResonantFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_BiquadResonantFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_BiquadResonantFilter_getParamMin;
    alias @nogc nothrow int function(int* aObjHandle, int aType, float aFrequency, float aResonance) da_BiquadResonantFilter_setParams;
    ...
    alias @nogc nothrow void function(int* aObjHandle, uint aVoiceHandle) da_Bus_annexSound;
    ...
    alias @nogc nothrow uint function(int* aObjHandle) da_Bus_getActiveVoiceCount;
    alias @nogc nothrow uint function(int* aObjHandle) da_Bus_getResampler;
    alias @nogc nothrow void function(int* aObjHandle, uint aResampler) da_Bus_setResampler;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Bus_setAutoStop;
    ...
    alias @nogc nothrow int function(int* aObjHandle) da_DCRemovalFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_DCRemovalFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_DCRemovalFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_DCRemovalFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_DCRemovalFilter_getParamMin;
    alias @nogc nothrow int* function() da_EchoFilter_create;
    alias @nogc nothrow int* function(int* aObjHandle) da_EchoFilter_destroy;
    alias @nogc nothrow int function(int* aObjHandle) da_EchoFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_EchoFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_EchoFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_EchoFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_EchoFilter_getParamMin;
    ...
    alias @nogc nothrow int function(int* aObjHandle) da_FFTFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_FFTFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_FFTFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_FFTFilter_getParamMax;
    ...
    alias @nogc nothrow int function(int* aObjHandle) da_FlangerFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_FlangerFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_FlangerFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_FlangerFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_FlangerFilter_getParamMin;
    alias @nogc nothrow int function(int* aObjHandle, float aDelay, float aFreq) da_FlangerFilter_setParams;
    alias @nogc nothrow int* function() da_FreeverbFilter_create;
    alias @nogc nothrow int* function(int* aObjHandle) da_FreeverbFilter_destroy;
    alias @nogc nothrow int function(int* aObjHandle) da_FreeverbFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_FreeverbFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_FreeverbFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_FreeverbFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_FreeverbFilter_getParamMin;
    alias @nogc nothrow int function(int* aObjHandle, float aMode, float aRoomSize, float aDamp, float aWidth) da_FreeverbFilter_setParams;
    alias @nogc nothrow int* function() da_LofiFilter_create;
    alias @nogc nothrow int* function(int* aObjHandle) da_LofiFilter_destroy;
    alias @nogc nothrow int function(int* aObjHandle) da_LofiFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_LofiFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_LofiFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_LofiFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_LofiFilter_getParamMin;
    ...
    alias @nogc nothrow int function(int* aObjHandle, const(ubyte)* aMem, uint aLength, int aCopy, int aTakeOwnership) da_Monotone_loadMemEx;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Monotone_setAutoStop;
    ...
    alias @nogc nothrow int* function() da_Noise_create;
    alias @nogc nothrow int* function(int* aObjHandle) da_Noise_destroy;
    alias @nogc nothrow void function(int* aObjHandle, float aOct0, float aOct1, float aOct2, float aOct3, float aOct4, float aOct5, float aOct6, float aOct7, float aOct8, float aOct9) da_Noise_setOctaveScale;
    alias @nogc nothrow void function(int* aObjHandle, int aType) da_Noise_setType;
    alias @nogc nothrow void function(int* aObjHandle, float aVolume) da_Noise_setVolume;
    alias @nogc nothrow void function(int* aObjHandle, int aLoop) da_Noise_setLooping;
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Noise_setAutoStop;
    alias @nogc nothrow void function(int* aObjHandle, float aMinDistance, float aMaxDistance) da_Noise_set3dMinMaxDistance;
    alias @nogc nothrow void function(int* aObjHandle, uint aAttenuationModel, float aAttenuationRolloffFactor) da_Noise_set3dAttenuation;
    alias @nogc nothrow void function(int* aObjHandle, float aDopplerFactor) da_Noise_set3dDopplerFactor;
    alias @nogc nothrow void function(int* aObjHandle, int aListenerRelative) da_Noise_set3dListenerRelative;
    alias @nogc nothrow void function(int* aObjHandle, int aDistanceDelay) da_Noise_set3dDistanceDelay;
    alias @nogc nothrow void function(int* aObjHandle, int* aCollider, int aUserData) da_Noise_set3dColliderEx;
    alias @nogc nothrow void function(int* aObjHandle, int* aAttenuator) da_Noise_set3dAttenuator;
    alias @nogc nothrow void function(int* aObjHandle, int aMustTick, int aKill) da_Noise_setInaudibleBehavior;
    alias @nogc nothrow void function(int* aObjHandle, double aLoopPoint) da_Noise_setLoopPoint;
    alias @nogc nothrow double function(int* aObjHandle) da_Noise_getLoopPoint;
    alias @nogc nothrow void function(int* aObjHandle, uint aFilterId, int* aFilter) da_Noise_setFilter;
    alias @nogc nothrow void function(int* aObjHandle) da_Noise_stop;
    ...
    alias @nogc nothrow int function(int* aObjHandle, const(ubyte)* aMem, uint aLength, int aCopy, int aTakeOwnership) da_Openmpt_loadMemEx;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Openmpt_setAutoStop;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Queue_setAutoStop;
    ...
    alias @nogc nothrow int function(int* aObjHandle) da_RobotizeFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_RobotizeFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_RobotizeFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_RobotizeFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_RobotizeFilter_getParamMin;
    alias @nogc nothrow void function(int* aObjHandle, float aFreq, int aWaveform) da_RobotizeFilter_setParams;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Sfxr_setAutoStop;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Speech_setAutoStop;
    ...
    alias @nogc nothrow int function(int* aObjHandle, const(ubyte)* aMem, uint aLength, int aCopy, int aTakeOwnership) da_TedSid_loadMemEx;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_TedSid_setAutoStop;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Vic_setAutoStop;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Vizsn_setAutoStop;
    ...
    alias @nogc nothrow int function(int* aObjHandle, const(ubyte)* aMem, uint aLength, int aCopy, int aTakeOwnership) da_Wav_loadMemEx;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_Wav_setAutoStop;
    ...
    alias @nogc nothrow int function(int* aObjHandle, float aAmount) da_WaveShaperFilter_setParams;
    alias @nogc nothrow int function(int* aObjHandle) da_WaveShaperFilter_getParamCount;
    alias @nogc nothrow const(char)* function(int* aObjHandle, uint aParamIndex) da_WaveShaperFilter_getParamName;
    alias @nogc nothrow uint function(int* aObjHandle, uint aParamIndex) da_WaveShaperFilter_getParamType;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_WaveShaperFilter_getParamMax;
    alias @nogc nothrow float function(int* aObjHandle, uint aParamIndex) da_WaveShaperFilter_getParamMin;
    ...
    alias @nogc nothrow int function(int* aObjHandle, const(ubyte)* aData, uint aDataLen, int aCopy, int aTakeOwnership) da_WavStream_loadMemEx;
    ...
    alias @nogc nothrow void function(int* aObjHandle, int aAutoStop) da_WavStream_setAutoStop;
